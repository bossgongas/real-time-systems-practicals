...
/*
*	Exercicio 5: Escalonamento com ROUND_ROBIN 
...
#define POLICY		SCHED_RR	//ALteração da politica de escalonamento para Round-Robin 
	...
	*/
	...
	for(i=0; i < N_Threads; i++){
		...
		*/
		...
		//param[i].sched_priority -= i;	// Agora todas as tarefas tem a mesma prioridade
